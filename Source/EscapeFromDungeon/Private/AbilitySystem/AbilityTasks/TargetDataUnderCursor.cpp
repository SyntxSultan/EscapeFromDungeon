...
void UTargetDataUnderCursor::Activate()
{
	...
	else
	{
		...
		const bool bDelegateCalled = AbilitySystemComponent.Get()->CallReplicatedTargetDataDelegatesIfSet(SpecHandle, ActivationPredictionKey);
		if (!bDelegateCalled)
		{
...
void UTargetDataUnderCursor::OnTargetDataReplicatedCallback(const FGameplayAbilityTargetDataHandle& Data, FGameplayTag ActivationTag)
{
